...
/**
     ...
     * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
     */e.openPumukitDialogue=async e=>{const t=(e=>e.options.get(a))(e),n=(e=>e.options.get(s))(e),o=(e=>e.options.get(m))(e),d=(e=>e.options.get(l))(e),p=(e=>e.options.get(r))(e),u=document.documentElement.lang||"en",g={modaltitle:t,pumukitUrl:n,hash:o,username:d,email:p,lang:u};try{const t=await i.create({templateContext:g,large:!0});t.show(),t.getRoot().one("shown.bs.modal",(()=>{t.getRoot().find(".nav-tabs a").on("click",(function(e){e.preventDefault(),$(this).tab("show")}))}));const o=i=>{const s=i.data;if(!s||!s.mmId&&!s.url&&!s.playlist)return;let a="";s.url?a=s.url:s.playlist?a=`${n}/openedx/openedx/playlist/embed/${s.playlist}`:s.mmId&&(a=`${n}/openedx/openedx/embed/${s.mmId}`);const l=`\n                <div class="embed-responsive embed-responsive-16by9">\n                    <iframe \n                        class="embed-responsive-item" \n                        src="${a}" \n                        width="100%" \n                        height="400" \n                        frameborder="0" \n                        allowfullscreen \n                        allow="microphone; camera; display-capture">\n                    </iframe>\n                </div>\n            `;e.insertContent(l),t.hide(),window.removeEventListener("message",o)};window.addEventListener("message",o),t.getRoot().on("hidden.bs.modal",(()=>{window.removeEventListener("message",o)}))}catch(e){console.error("Error creando la modal de PuMuKIT:",e)}}}));
